...
subtitle: "`dplyr`"
author: "[Brendan Cullen](https://education.rstudio.com/trainers/people/cullen+brendan/)"
instution: "Test"
output:
...
### [Certified RStudio Trainer](https://education.rstudio.com/trainers/people/cullen+brendan/)
### [`r icon::fa("envelope")`](mailto:bcullen@uoregon.edu) [bcullen@uoregon.edu](mailto:bcullen@uoregon.edu) | [`r icon::fa("twitter")`](https://twitter.com/_bcullen)  [_bcullen](https://twitter.com/_bcullen) | [`r icon::fa("github")`](https://github.com/brendanhcullen) [brendanhcullen](https://github.com/brendanhcullen)
