...
**Column-wise operations** are `dplyr` verbs (or other data transformation functions) applied across multiple columns simultaneously. 

--

e.g. Create new columns with `mutate()`
...
e.g. Summarize columns with `summarize()`
