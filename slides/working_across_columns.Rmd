...
e.g. Use `summarize()` to calculate the mean value of all bill dimensions (`bill_length`, `bill_depth`)
]
...
e.g. Use `summarize()` to calculate the mean value of all *numeric* variables.
]
